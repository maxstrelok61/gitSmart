package chat.WorkFiles;

import chat.WorkFiles.Data_File.JobInFiles;
import chat.WorkFiles.Data_File.MainFileClass;
...
public class WorkFileLines extends MainFileClass implements JobInFiles {
    ...
    public WorkFileLinesMod getModWriter(WorkFileLinesMod next) {
        return modWriter;
    }
