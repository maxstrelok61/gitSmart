...
public class ClientHandler {
    ...
    public ClientHandler(MyServer myServer, Socket clientSocket) {
        ...
        myServer.log.info(clientSocket.getRemoteSocketAddress() + " -> Установлено соединение");
    }
        ...
        while (true) {
            if (message.startsWith(AUTH_CMD_PREFIX)) {
                ...
                if (clientUsername != null) {
                    ...
                    myServer.log.info(AUTHERR_CMD_PREFIX + " Логин или пароль не соответствуют действительности");
                }
            } else {
                out.writeUTF(AUTHERR_CMD_PREFIX + " Ошибка авторизации");
                myServer.log.info(AUTHERR_CMD_PREFIX + " Ошибка авторизации");
            }
        }
    }
